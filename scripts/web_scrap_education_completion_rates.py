...
cc_df.columns = ['fips','county', 'rural_urban_code','1970','1980', '1990', '2000', '2018']
sc_df.columns = ['fips','county', 'rural_urban_code','1970','1980', '1990', '2000', '2018']
hso_df.columns = ['fips','county', 'rural_urban_code','1970','1980', '1990', '2000', '2018']
nchs_df.columns = ['fips','county', 'rural_urban_code','1970','1980', '1990', '2000', '2018']

cc_df[['1970','1980', '1990', '2000', '2018']] = cc_df[['1970','1980', '1990', '2000', '2018']].apply(lambda x: pd.to_numeric(x.str.strip('%'), errors = 'coerce'))
sc_df[['1970','1980', '1990', '2000', '2018']] = sc_df[['1970','1980', '1990', '2000', '2018']].apply(lambda x: pd.to_numeric(x.str.strip('%'), errors = 'coerce'))
hso_df[['1970','1980', '1990', '2000', '2018']] = hso_df[['1970','1980', '1990', '2000', '2018']].apply(lambda x: pd.to_numeric(x.str.strip('%'), errors = 'coerce'))
nchs_df[['1970','1980', '1990', '2000', '2018']] = nchs_df[['1970','1980', '1990', '2000', '2018']].apply(lambda x: pd.to_numeric(x.str.strip('%'), errors = 'coerce'))

cc_df.to_excel('/Users/ericbutcher/Education Completeness/data/completed_college_per_county.xlsx',index=False)
sc_df.to_excel('/Users/ericbutcher/Education Completeness/data/completed_some_college_per_county.xlsx',index=False)
hso_df.to_excel('/Users/ericbutcher/Education Completeness/data/completed_high_school_only_per_county.xlsx',index=False)
nchs_df.to_excel('/Users/ericbutcher/Education Completeness/data/not_complete_high_school_per_county.xlsx',index=False)
